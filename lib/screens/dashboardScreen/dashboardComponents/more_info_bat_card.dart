...
class _BatCardState extends State<BatCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final batStorageLevel = psManager.batStorage;
    final batCurrent = psManager.batCurrent.toStringAsFixed(2);
    final batVoltage = psManager.batVoltage.toStringAsFixed(2);
    return  Row(
      children: <Widget>[
        Expanded(
          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                alignment: const AlignmentDirectional(
                                    ...
                                    -0.050000000000000044),
                                child: Text(
                                  psManager.batPower.toStringAsFixed(2),
                                  style: FlutterFlowTheme.of(
                                      context)
                                      .bodyText1,
                                ),
