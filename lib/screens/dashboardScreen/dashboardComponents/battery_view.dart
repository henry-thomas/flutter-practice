...
class BatteryView extends StatefulWidget {
  ...
  const BatteryView({Key? key, this.percentageValue = 100.0}) : super(key: key);
  @override
  _BatteryViewStae createState() => _BatteryViewStae();
}

class _BatteryViewStae extends State<BatteryView> with TickerProviderStateMixin {
