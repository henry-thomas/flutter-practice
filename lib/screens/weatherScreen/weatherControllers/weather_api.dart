...
class WeatherApi extends ChangeNotifier {
  ...
  Image weatherIcon =Image.network('http://openweathermap.org/img/w/01n.png',);
  ...
  ws = new WeatherFactory(key);
    ...
    _data = [weather];
      ...
      weatherIcon = Image.network('http://openweathermap.org/img/w/$weatherIconCode.png',);
